...
function cFields(){
    goals = 0;
    passes = 0;
    document.getElementById("dGoals").innerHTML="Goals: 0";
    document.getElementById("dPasses").innerHTML="Passes: 0";
}
function pGoals(){
    if(goals < 0){
        goals = 0;
    ...
    goals = goals+1;
    document.getElementById("dGoals").innerHTML="Goals: "+goals;
}
function mGoals(){
    goals = goals-1;
    if(goals < 0){
...
function pPasses(){
    ...
    passes = passes+1;
    document.getElementById("dPasses").innerHTML="Passes: "+passes;
}
function mPasses(){
    passes = passes-1;
    if(passes < 0){
